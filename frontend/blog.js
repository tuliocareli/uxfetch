document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        posts.forEach(post => {
            ...
            card.href = `artigo.html?slug=${post.slug}`;
            ...
            card.innerHTML = `
                ...
                <div class="uxf-card-content" style="height: 150px;">
                    ...
                    <h3 class="uxf-book-title" style="font-size: 1rem; margin-bottom: 8px;">${post.titulo}</h3>
                    <p class="uxf-book-desc" style="font-size: 0.8rem; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical;">${post.resumo}</p>
                </div>
            `;
